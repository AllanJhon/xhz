 ...
 */
package com.sjz.zyl.appdemo.service;
...
import com.sjz.zyl.appdemo.CrashHandler;
...
//        kjh.get("https://xhznew.com/api/v1/checkupdate/2", new HttpCallBack() {
        kjh.get("https://xhznew.com/api/v1/checkupdate/2", new HttpCallBack() {
            @Override
...
//            }
    ...
    private void download(String url) {
        ...
        File tempFile = new File(folder + "/xhz.apk.tmp");
        if (tempFile.exists()) {
            tempFile.delete();
        }
        ViewInject.toast("正在为你下载新版本");
        kjh.download(folder + "/xhz.apk", url, new HttpCallBack() {
            /**
             * 下载过程
             */
            @Override
